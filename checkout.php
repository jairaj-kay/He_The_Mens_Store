...
echo "error in connection";  
                            ...
                            $sql = "SELECT * FROM addcart where user='$user'";
                                $i=0;
                        
                            

                            $sresult=mysqli_query($connect,$sql);
                                while($cart=mysqli_fetch_row($sresult))
                                {
                        ...
                        <ul class="order-details-form mb-4">
                            ...
                            $subtotal = 0;
                             for($i=0;$i<$psize;$i++)
                                ...
                                {
                                    $finalprice[$i] = $info[$i][3] *(int)$price[$i];
                                    $subtotal = $subtotal+$finalprice[$i];
                                    echo '<li><span>'.$pinfo[$i].'</span> <span>'.$info[$i][3].'</span> <span>Rs '.$finalprice[$i].'</span></li>';
                            ...
                            <li><span>Total</span> <span><?php  echo $subtotal; ?></span></li>
                        </ul>
